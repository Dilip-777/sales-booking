...
export default function Account(){
    return (
        ...
        <div className="border-t col-span-2  border-gray-300 my-4"></div>
           <Notify name="Orders Notification" description="Email me when order is placed"/>
           <Notify name="Despatch Notification" description="Email me when order is dispatched"/>
           <Notify name="Deletion Notification" description="Email me when someone deletes an item"/>
        </div>
        </CardContent>
        </Card>
        </div>
...
function Notify({name,description}:{name:string; descript:string}){
    return (
